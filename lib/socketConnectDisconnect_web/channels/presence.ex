defmodule SocketConnectDisconnectWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule SocketConnectDisconnect.MyChannel do
        use SocketConnectDisconnectWeb, :channel
        alias SocketConnectDisconnectWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :socketConnectDisconnect,
                        pubsub_server: SocketConnectDisconnect.PubSub
end
